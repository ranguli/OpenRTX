...
// 128x48 display: Radioddity RD-5R
constexpr Params params = {
    ...
    .fonts = {
        ...
        .line1      = {FONT_SIZE_5PT,  SYMBOLS_SIZE_5PT}, // not present on this resolution
        .line2      = {FONT_SIZE_6PT,  SYMBOLS_SIZE_6PT},
        .line3      = {FONT_SIZE_6PT,  SYMBOLS_SIZE_6PT},
        .line3_large = FONT_SIZE_12PT,
        .line4      = {FONT_SIZE_6PT,  SYMBOLS_SIZE_6PT},
        .bottom     = FONT_SIZE_5PT,                      // not present on this resolution
        .input      = FONT_SIZE_8PT,
        .menu       = FONT_SIZE_6PT,
...
static_assert(CONFIG_SCREEN_HEIGHT > 47 && CONFIG_SCREEN_HEIGHT < 64,
