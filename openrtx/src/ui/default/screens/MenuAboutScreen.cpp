...
#endif
static const uint8_t about_author_num =
    sizeof(about_authors) / sizeof(about_authors[0]);
...
public:
    ...
    void draw(UIContext& ctx) override
    {
        ...
        logo_pos.y = ctx.layout.line3_h;
        gfx_print(logo_pos, ctx.layout.line3_font, TEXT_ALIGN_CENTER,
                  color_white, "OpenRTX");
#else
        ...
        else
        {
            ...
            gfx_print(logo_pos, ctx.layout.line3_large_font,
        ...
        uint8_t entries_in_screen =
            (CONFIG_SCREEN_HEIGHT - 1 - pos.y) / ctx.layout.menu_h + 1;
